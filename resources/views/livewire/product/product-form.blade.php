<div class="py-8">
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
        ...
        <form wire:submit.prevent="saveProduct" class="bg-white dark:bg-gray-800 p-6 md:p-8 rounded-lg shadow-md">
            {{-- Product Details Section --}}
            <fieldset class="border border-gray-300 dark:border-gray-600 p-4 rounded-md mb-8">
                    ...
                    @foreach ($variants as $index => $variant)
                        <div wire:key="variant-{{ $index }}" class="bg-gray-50 dark:bg-gray-900/50 p-4 rounded-md border border-gray-200 dark:border-gray-700">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-x-6 gap-y-4 items-end">
                                ...
                                <div>
                                    <label for="cost-price-{{ $index }}" class="block text-xs font-medium text-gray-700 dark:text-gray-400 mb-1">Cost (OMR)</label>
                                ...
                                <div>
                                    <label for="selling-price-{{ $index }}" class="block text-xs font-medium text-gray-700 dark:text-gray-400 mb-1">Price (OMR)</label>
                                ...
                                <div class="flex items-end space-x-2">
                                     <div class="flex-grow">
                                        <label for="barcode-{{ $index }}" class="block text-xs font-medium text-gray-700 dark:text-gray-400 mb-1">Barcode</label>
            ...
            <div class="mt-8 flex justify-end items-center space-x-4">
                ...
                <button type="submit"
                    ...
                    <svg wire:loading wire:target="saveProduct" class="animate-spin -ml-1 mr-3 h-5 w-5 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
