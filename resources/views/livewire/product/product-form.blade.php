    ...
    <div class="max-w-4xl mx-auto px-2 sm:px-6 lg:px-8">
        ...
        <form wire:submit.prevent="save" class="bg-white dark:bg-gray-800 p-4 sm:p-6 md:p-8 rounded-lg shadow-md">
            ...
            <fieldset class="border border-gray-300 dark:border-gray-600 p-4 rounded-md mb-6">
                ...
                {{-- This grid collapses to a single column on mobile automatically --}}
                    ...
                    <div class="space-y-4 mt-4">
                        @foreach ($variants as $index => $variant)
                            <div wire:key="variant-{{ $index }}" class="bg-gray-50 dark:bg-gray-900/50 p-4 rounded-md border border-gray-200 dark:border-gray-700">
                                ...
                                {{-- DESKTOP (GRID) VIEW for Variants --}}
                                ...
                                <div class="lg:hidden space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" id="mobile-variant-barcode-{{ $index }}" wire:model.lazy="variants.{{ $index }}.barcode" class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm p-2" placeholder="Optional">
                                    </div>
                                </div>
                            </div>
                        @endforeach
            ...
            @else
                {{-- Pricing & Inventory for products WITHOUT Variants --}}
                <fieldset class="border border-gray-300 dark:border-gray-600 p-4 rounded-md">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-4">
                        ...
                        <div>
                            ...
                            <input type="text" id="barcode" wire:model.lazy="barcode" class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm p-2" placeholder="Optional">
