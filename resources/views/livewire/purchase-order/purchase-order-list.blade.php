        ...
        <div class="mb-6 bg-yellow-50 dark:bg-yellow-800/50 border-l-4 border-yellow-400 dark:border-yellow-600 p-4 shadow-md rounded-md"
            ...
            <div class="flex">
                <div class="flex-shrink-0">
                    <svg class="h-5 w-5 text-yellow-500 dark:text-yellow-400" xmlns="http://www.w3.org/2000/svg"
                ...
                <div class="ml-3">
                    <p class="text-sm text-yellow-700 dark:text-yellow-200">{{ session('warning_negative_stock') }}</p>
                </div>
            </div>
        </div>
    @endif
        ...
        {{-- =================================================== --}}
        {{-- Purchase Orders Table (Adopted from Products Page) --}}
        {{-- =================================================== --}}
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full
                                        @switch($po->status)
                                            @case('ordered') bg-yellow-100 text-yellow-800 dark:bg-yellow-900/50 dark:text-yellow-300 @break
                                            @case('received') bg-green-100 text-green-800 dark:bg-green-900/50 dark:text-green-300 @break
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium space-x-3">
                                    ...
                                    <button wire:click="deletePurchaseOrder({{ $po->id }})" wire:confirm="Are you sure?"
                                ...
                                <td colspan="6" class="px-6 py-12 text-center text-sm text-gray-500 dark:text-gray-400">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-12 h-12 text-gray-400 dark:text-gray-500 mb-3">
                                          <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 7.5V6.108c0-1.135.845-2.098 1.976-2.192.373-.03.748-.057 1.123-.08M15.75 18H18a2.25 2.25 0 0 0 2.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 0 0-1.123-.08M15.75 18.75v-1.875a3.375 3.375 0 0 0-3.375-3.375h-1.5a1.125 1.125 0 0 1-1.125-1.125v-1.5A3.375 3.375 0 0 0 6.375 7.5v1.5a1.125 1.125 0 0 1-1.125 1.125h-1.5a3.375 3.375 0 0 0-3.375 3.375V18.75m13.5 0h-13.5" />
                                        </svg>
